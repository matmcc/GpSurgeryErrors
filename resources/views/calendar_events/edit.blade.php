        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('calendar_events.update', $calendar_event->id) }}" method="POST">
                ...
                <div class="form-group">
                     ...
                     <input type="text" id="title" name="title" class="form-control" value="{{$calendar_event->title}}"/>
                </div>
<!--
...
-->
                    ...
                    <div class="form-group">
                     ...
                     <input type="text" id="is_all_day" name="is_all_day" class="form-control" value="{{$calendar_event->is_all_day}}"/>
                </div>
                    <div class="form-group">
                     <label for="background_color">BACKGROUND_COLOR</label>
                     <input type="text" id="background_color" name="background_color" class="form-control" value="{{$calendar_event->background_color}}"/>
                </div>
